		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
		 ...
		 <div class="mb-12 row">
		    <div class="col-sm-10">
		    	<br>
		    <center>
		    	 <a href="http://localhost/basicophp/vista/categoria/create.php" class="btn btn-primary">Agregar</a>
		    </center>
		    <br>
		    </div>
		  </div>
		<div  class="row">
			<div class="col-sm-12">
						<center>
						  ...
						  <tbody>
						  		<?php 
						  		$categoria=CategoriaControlador::Listar();
						  		foreach ($categoria as  $cat) {
						  	echo '<tr>
								      <th scope="row">'.$cat['id'].'</th>
								      <td>'.$cat['nombre'].'</td>
								       <td>
								       	<a href="http://localhost/basicophp/vista/categoria/edit.php?id='.$cat['id'].'" class="btn btn-info">Editar</a>
...
<?php 
$categ=new CategoriaControlador();
$categ->eliminar();
 ?>