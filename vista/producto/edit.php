...
$producto=ProductoControlador::mostrar();
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<center>
			    ...
			    <div class="col-sm-5">
			     <select class="form-control" name="categoria_id">
			      	...
			      	foreach ($categoria as $cat) {
			      		...
			      		echo '<option value="'.$cat['id'].'"  '.$se.'>'.$cat['nombre'].'</option>';
			      	}
			      	 ?>
			      </select>
			    </div>
			  ...
			  <div class="form-group row">
			    <div class="col-sm-10">
			      ...
			      <a href="http://localhost/basicophp/vista/producto/" class="btn btn-danger">Cancelar</a>
			    </div>
			  </div>
			</form>	
			</center>
